...
<body>
    ...
    <div class="wrapper">
        ...
        <section class="introText ">
            <label class="" >
                <input type="checkbox">
                <div class="textFrame hidden noMove left">
            ...
            <div class="sponsorshipPackage hidden noMove right">
                <div class="packageTitleFrame">
                    <p>CHECK OUT OUR SPONSORSHIP PACKAGE ...</p>
                    
                </div>
                <a href="assets/Formula_2023-2024_Sponsorship_package.pdf">
                    <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="Interface / Link_Horizontal"><path id="Vector" d="M8 12H16M15 8H17C19.2091 8 21 9.79086 21 12C21 14.2091 19.2091 16 17 16H15M9 8H7C4.79086 8 3 9.79086 3 12C3 14.2091 4.79086 16 7 16H9" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></g></svg>
                </a>
            </div>
        </section>
        ...
        <section class="categories">
            ...
            check_delete_error();
            ?>
            <div class="titleSponsor hidden">
                <?php
                    output_images($uploaded_sponsors, 'title');
                ?>
            </div>
            <div class="twoCategories PlatGold">
                <div class="category platinum hidden">
                    <h1>PLATINUM</h1>
                    <?php
                        output_images($uploaded_sponsors, 'platinum');
                    ?>
                </div>
                <div class="category gold hidden">
                    <h1>GOLD</h1>
                    <?php
                        output_images($uploaded_sponsors, 'gold');
                    ?>
                </div>
            </div>  
            <div class="twoCategories SilverBronze">
                <div class="category silver hidden">
                    <h1>SILVER</h1>
                    <?php
                        output_images($uploaded_sponsors, 'silver');
                    ?>
                </div>
                <div class="category bronze hidden">
                    <h1>BRONZE</h1>
                    <?php
                        output_images($uploaded_sponsors, 'bronze');
                    ?>
                </div>
            </div>
            <p class="date hidden">Last Modified: <span id="datetime"></span></p>
        </section>
